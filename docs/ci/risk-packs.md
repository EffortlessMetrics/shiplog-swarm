...
| `schema-ids` | Stable contract modules (schema, ids, ports) | `apps/shiplog/src/schema/**`, `apps/shiplog/src/ids.rs`, `apps/shiplog/src/ports.rs` | `mutation` | `mutation_targeted`, `property` |
