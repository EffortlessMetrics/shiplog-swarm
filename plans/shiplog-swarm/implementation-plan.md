...
EffortlessMetrics/shiplog#572:
  swarm head: bbcde94bec72c6e1ed9e777f18e3b0622c268b3e
  included swarm PRs: EffortlessMetrics/shiplog-swarm#135
  source merge: d043baf5bd1fc56d89f8ccc0e5eb33a1b395aee8
  result: regular merge commit; PR-body generation now surfaces compact recent
          PR receipt refs instead of older narrative closure notes; swarm PR
          routed proof passed through GitHub-hosted fallback in run 26769447517,
          swarm/main routed proof passed through GitHub-hosted fallback in run
          26769915818, source PR routed proof passed through GitHub-hosted
...
EffortlessMetrics/shiplog#576:
  swarm head: e270c48999546a0766ad2cbb32130e29f6206a24
  included swarm PRs: EffortlessMetrics/shiplog-swarm#139
  source merge: 63440e6b76af107482cb642a65b3013039e5d6b9
  result: regular merge commit; active-goal and implementation-plan receipts
          through #138/#575 were refreshed, swarm PR routed proof passed
          through GitHub-hosted fallback in run 26781450807, swarm/main routed
          proof passed through GitHub-hosted fallback in run 26781921383,
          source PR routed proof passed through GitHub-hosted fallback in run
...
EffortlessMetrics/shiplog#589:
  swarm head: 9d2a7a345bdf2e3cb0a31d1874649885343ef356
  included swarm PRs: EffortlessMetrics/shiplog-swarm#152
  source merge: 67ac2181e73af421bd464e5b683e2ebdae433654
  result: regular merge commit; `cargo xtask promotion-body` now supports
          explicit swarm head and included swarm PR inputs for final proof
          updates after source/swarm refs align, active-goal and
          implementation-plan receipts carried the #151/#588 receipt refresh,
          swarm PR routed proof passed through GitHub-hosted fallback in run
          26809053685, swarm/main routed proof passed through GitHub-hosted
          fallback in run 26809523308, source PR routed proof passed through
          GitHub-hosted fallback in run 26810019933, and source post-merge
          routed proof passed through GitHub-hosted fallback in run 26811022845

EffortlessMetrics/shiplog#590:
  swarm head: f260db3eb4eb564e98c56f4fd232c681ecf26e0b
  included swarm PRs: EffortlessMetrics/shiplog-swarm#153
  source merge: 0fdc2f48f3f15b2e444569460dbcb3c0e38aee6e
  result: regular merge commit; repo-contract-report now names exact missing
          source and swarm receipt refs in the top recommended next slice,
          active-goal and implementation-plan receipts carried the #152/#589
          receipt refresh, swarm PR routed proof passed through GitHub-hosted
          fallback in run 26812016152, swarm/main routed proof passed in run
          26812554439, source PR routed proof passed in run 26813036617, and
          source post-merge routed proof passed in run 26813576612

EffortlessMetrics/shiplog#591:
  swarm head: bfbc2e9e7fb24b7dbe18fb7206c0004b03b08b45
  included swarm PRs: EffortlessMetrics/shiplog-swarm#154
  source merge: 775fa680fec1a1f77b8a4e57402d111d4a3b9ca8
  result: regular merge commit; repo-contract-report now surfaces large
          unprotected local branch inventories as non-destructive review hints,
          active-goal and implementation-plan receipts carried the #153/#590
          receipt refresh, swarm PR routed proof passed through GitHub-hosted
...
EffortlessMetrics/shiplog#596:
  swarm head: 13c3289396a58b3a7cce3ef34016ba0a3299b88d
  included swarm PRs: EffortlessMetrics/shiplog-swarm#159
  source merge: 567feaad9c53bdeb58e021b710357b7ae5aa768e
  result: regular merge commit; the plan-item template now uses the
          repo-required `rtk` command prefix for proof-command examples,
          active-goal and implementation-plan receipts carried the #158/#595
          receipt refresh, swarm PR routed proof passed through GitHub-hosted
          fallback in run 26829467606, swarm/main routed proof passed through
          GitHub-hosted fallback in run 26829996964, source PR routed proof
