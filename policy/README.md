...
| `automation-authority.toml` | repo-infra/release | Explicit swarm/source automation effects; `check-automation-authority --repository-role <swarm\|source>`. Human guide: [`docs/governance/automation-authority.md`](../docs/governance/automation-authority.md) |
